...
import RetailTab from "./components/RetailTab";
...
import { generateRankings } from "./utils/rankings";
...
export default function App() {
  ...
  // Calculate monthly ranking for header (default to last 30 days / Dec)
  const monthlyRank = useMemo(
    () => generateRankings(selected, brands, "All", "All", "30d"),
    [selected],
  );
