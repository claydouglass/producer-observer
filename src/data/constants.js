...
export const kpiData = [
  ...
  { label: 'Market Share', value: '2.78%', sub: 'of store revenue', delta: '+0.4%' },
...
export const categoryBreakdown = [
  ...
  { id: 'concentrates', name: 'Concentrates', pct: 29, delta: 45, color: '#8b5cf6' },
  { id: 'cartridges', name: 'Cartridges', pct: 27, delta: 38, color: '#f59e0b' },
...
export const partnershipMetrics = [
  ...
  { label: 'Mutual growth', value: '+23%', target: '+15%', status: 'excellent' },
];
